...
CMD ["sh", "-c", "echo \"tolerance \" && for i in {10..20}; do echo -n \"     1e-\$i\"; done && python python_small_tolerance.py && node javascript_small_tolerance.js && java Java_small_tolerance"]
